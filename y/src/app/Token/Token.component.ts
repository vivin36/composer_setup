...
export class TokenComponent implements OnInit {
  ...
  constructor(public serviceToken: TokenService, fb: FormBuilder) {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.opensource.token.Token',
      'token': this.token.value,
      'tokenName': this.tokenName.value,
      'tokenQuantity': this.tokenQuantity.value
    };
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceToken.updateAsset(form.get('token').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.tokenName) {
        formObject.tokenName = result.tokenName;
      } else {
        formObject.tokenName = null;
      }

      if (result.tokenQuantity) {
        formObject.tokenQuantity = result.tokenQuantity;
      } else {
        formObject.tokenQuantity = null;
      }
